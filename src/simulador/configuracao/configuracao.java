...
public class configuracao {
    ...
    public static final int QTD_CAMINHOES_8T = 2;
    public static final int VIAGENS_CAMINHOES_8T = 2;
    public static final int CAPACIDADE_CAMINHOES_8T = 8;

    public static final int QTD_CAMINHOES_10T = 1;
    public static final int VIAGENS_CAMINHOES_10T = 2;
     ...
     */
    public static final int TEMPO_MAX_ESPERA_ESTACAO = 100; // em minutos
